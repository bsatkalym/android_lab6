...
public class MySQLite extends SQLiteOpenHelper {
    ...
    static final String DATABASE_NAME = "SM"; // Имя базы данных

    static final String TABLE_NAME = "smachin"; // Имя таблицы
    ...
    static final String ASSETS_FILE_NAME = "smachin.txt"; // Имя файла из ресурсов с данными для БД
